...
numpy_dataset_destination_address_and_filename = '../datasets/fysioprim082017_dataset_file'
excel_dataset_address = '../datasets/fysioprim_08_2017_utenlabels.xlsx'
...
attributes_for_clustering = ['arbeidsevne_1', 'keelestartback_risk_1',  'smertevarighet', 'orebro_total_1', 'aktivitetsnivaa_1', 'hscl_mean_1']
